...
Config.NPCJobEarnings             = {min = 3000, max = 3500}
...
Config.AuthorizedVehicles = {
	...
	{ model = '2020rs6',  label = '公司車', price = 200000 },
...
Config.Zones = {
	...
	VehicleSpawner = {
		Pos   = {x = -1394.07, y = -587.34, z = 30.27},
	...
	VehicleSpawnPoint = {
		Pos     = {x = -1379.23, y = -584.03, z = 29.83},
		InsideShop = {x = -1379.23, y = -584.03, z = 29.83},
	...
	TaxiActions = {
		Pos   = {x = -1377.92, y = -626.08, z = 30.82 },
		Size  = {x = 1.0, y = 1.0, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 20, Rotate = true
	},
