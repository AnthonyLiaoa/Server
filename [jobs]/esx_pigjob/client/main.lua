...
local Positions = {
	['StartHunting'] = { ['hint'] = '[E] 開始工作', ['x'] = 2385.1276855469, ['y'] = 5032.7734375, ['z'] = 45.946147918701 },
	['Sell'] = { ['hint'] = '[E] 販售豬肉', ['x'] = 1955.05438232422, ['y'] = 3838.85578125, ['z'] = 32.183960647583 },
    ---['Porkpack'] = { ['hint'] = '[E] 豬肉包', ['x'] = 949.0, ['y'] = -2123.7908105469, ['z'] = 31.43868270874 }
				...
				for index, value in ipairs(AnimalsInSession) do
					if DoesEntityExist(value.id) then
						...
						if PlyToAnimal < 2.0 then
							...
							ESX.Game.Utils.DrawText3D({x = AnimalCoords.x, y = AnimalCoords.y, z = AnimalCoords.z + 1}, '[E] 殺豬', 0.4)
...
function SlaughterAnimal(AnimalId)
	...
	ESX.ShowNotification('您宰了豬，收到了豬肉')
