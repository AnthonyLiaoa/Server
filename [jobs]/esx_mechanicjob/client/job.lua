...
function OpenAmbulanceActionsMenu()
	local elements = {
		...
		{label = '拿取物品',  value = 'get_stock'},
 {label = '放置物品', value = 'put_stock'}
	}
          ...
          function(data, menu)
            ...
            if amount == nil then
              ...
              if closestPlayer == -1 or closestDistance > 3.0 then
                ...
                TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_ambulance', _U('writenbills'), amount)
              end
            end
          end,
        function(data, menu)
...
function OpenPharmacyMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pharmacy', {
		...
		elements = {
			...
			{label = _U('pharmacy_take', '止咳藥 </span> 1:50 ')      , value = 'sciroppo'},
			{label = _U('pharmacy_take', '止咳藥水 </span> 1:50 '), value = 'antibioticorosacea'},
			{label = _U('pharmacy_take', '抗生素 </span> 1:50'), value = 'antibiotico'}
		}
	}, function(data, menu)
