...
AddEventHandler('esx_policejob:confiscatePlayerItem', function(target, itemType, itemName, amount)
	...
	if itemType == 'item_standard' then
		...
		if targetItem.count > 0 and targetItem.count <= amount then
			...
			if sourceItem.limit ~= -1 and (sourceItem.count + amount) > sourceItem.limit then
				...
				TriggerEvent('azk_discordlogs:PoliceLogs', 'confiscate', _source, sourceItem.label, amount, target)
			end
		else
			TriggerClientEvent('esx:showNotification', _source, _U('quantity_invalid'))	
		end
	...
	elseif itemType == 'item_account' then
		...
		TriggerEvent("esx_addonaccount:getSharedAccount", "society_police_blackMoney", function(account)
            account.addMoney(amount)
        end)
		TriggerClientEvent('esx:showNotification', _source, _U('you_confiscated_account', amount, itemName, targetXPlayer.name))
		TriggerClientEvent('esx:showNotification', target,  _U('got_confiscated_account', amount, itemName, sourceXPlayer.name))
		TriggerEvent('azk_discordlogs:PoliceLogs', 'confiscate', _source, itemName, amount, target)
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_police', function(inventory)
		...
		if count > 0 and inventoryItem.count >= count then
			...
			if sourceItem.limit ~= -1 and (sourceItem.count + count) > sourceItem.limit then
				...
				TriggerEvent('azk_discordlogs:PoliceLogs', 'get', _source,  inventoryItem.label, count, source)
...
AddEventHandler('esx_policejob:putStockItems', function(itemName, count)
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_police', function(inventory)
		...
		if sourceItem.count >= count and count > 0 then
			...
			TriggerEvent('azk_discordlogs:PoliceLogs', 'put', xPlayer.source,  inventoryItem.label, count, xPlayer.source)
		else
...
ESX.RegisterServerCallback('esx_policejob:addArmoryWeapon', function(source, cb, weaponName, removeWeapon)
	...
	TriggerEvent('azk_discordlogs:PoliceLogs', 'put', source,  weaponName, 1000, source)
...
ESX.RegisterServerCallback('esx_policejob:removeArmoryWeapon', function(source, cb, weaponName)
	...
	TriggerEvent('azk_discordlogs:PoliceLogs', 'get', source,  weaponName, 1000, source)
...
RegisterServerEvent("esx_policejob:tracker")
AddEventHandler("esx_policejob:tracker", function(plate)
...
AddEventHandler("esx_policejob:triggerTimer", function(plate)
    ...
    Citizen.CreateThread(function()
        ...
        for i=1, #xPlayers, 1 do
            ...
            if xPlayers.job.name == 'police' then
...
ESX.RegisterServerCallback("esx_policejob:getSharedAccount", function(source, cb)
	TriggerEvent("esx_addonaccount:getSharedAccount", "society_police_blackMoney", function(account)
		local blackMoney
...
RegisterServerEvent("esx_policejob:putBlackMoney")
AddEventHandler("esx_policejob:putBlackMoney", function(amount)
	TriggerEvent("esx_addonaccount:getSharedAccount", "society_police_blackMoney", function(account)
		local _source = source
		local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent("esx_policejob:getBlackMoney")
AddEventHandler("esx_policejob:getBlackMoney", function(count)
	TriggerEvent("esx_addonaccount:getSharedAccount", "society_police_blackMoney", function(account)
		local _source = source
		local xPlayer = ESX.GetPlayerFromId(_source)
