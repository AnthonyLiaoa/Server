...
AddEventHandler('esx_farmdelaranjas:GetUserInventory', function(currentZone)
	...
	TriggerClientEvent('esx_farmdelaranjas:ReturnInventory',_source,xPlayer.getInventoryItem('laranja').count,xPlayer.getInventoryItem('sumo_de_laranja').count,xPlayer.job.name,currentZone)
end)
