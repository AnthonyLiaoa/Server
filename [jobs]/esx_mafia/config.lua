...
Config.MafiaStations = {
	...
	LSPD = {
		...
		Blip = {
			Coords  = vector3(-802.36, 1294.58, 196.48),
			Sprite  = 439,
			Display = 4,
			Scale   = 1.0,
			Colour  = 58
		...
		Armories = {
			vector3(-960.61, 1343.3, 300.47)
		},

		Vehicles = {
			{
				Spawner = vector3(-972.12, 1321.75, 300.47),
				InsideShop = vector3(-968.03, 1324.44, 299.47),
				SpawnPoints = {
					{ coords = vector3(-968.03, 1324.44, 299.47), heading = 181.33, radius = 6.0 },
				}
			}
		},
...
Config.AuthorizedVehicles = {
	Shared = {
		{ model = 'mansm8', label = '公司車', price = 200000 },
	},
