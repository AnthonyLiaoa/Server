    ...
    function(data, menu)
      if data.current.value == 'vehicle_list' then
        ...
        if Config.EnableSocietyOwnedVehicles then
            ...
            local elements = {
			  {label = 'Weazel News Hiacesc', value = 'hiacesc'},
			  {label = 'Weazel News Mocpacker2', value = 'mocpacker2'}			  
            }
...
ESX.UI.Menu.CloseAll()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'factu_weazelnews_actions',
    {
      ...
      align    = 'top-left',
      elements = {
        {label = '[ 📝 ] 開票', value = 'facture_client'},		
        {label = '[ 🎤 ] 微型/相機',   value = 'menucam'},
        {label = '[ 🎥 ] 公告', value = 'annonce'}		
      },
    },
...
AddEventHandler('sp_weazelnews:annoncestop', function()
  ...
  --   -- Example {title="", colour=, id=, x=, y=, z=},-591.51, y = -929.81, z = 22.86
	-- {title="香港電台-金沙集團", colour=-1, id=184, x =-1083.61, y = -254.35, z = 37.76,}, -- Location to obtain supplies needed to make cocaine at Drug Processing Location
  -- }
