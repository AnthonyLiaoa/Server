Config.Jobs.textil = {
  ...
  Zones = {
    ...
    Whool = {
      ...
      Hint  = _U('dd_pickup'),
      GPS = {x = 731.27, y = -924.08, z = 24.8}
    },

    Fabric = {
      Pos   = {x = 731.27, y = -924.08, z = 24.8},  --做布x = 715.954650878906, y = -959.639587402344, z = 29.3953247070313 
      Size  = {x = 3.0, y = 3.0, z = 1.0},
      Color = {r = 204, g = 204, b = 0},
      Marker= 1,
      Blip  = true,
      ...
      Item  = {
        {
          ...
          time   = 500,
          remove = 1,
          max    = 10000000, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
          price  = 2500,
          requires = "clothe",
