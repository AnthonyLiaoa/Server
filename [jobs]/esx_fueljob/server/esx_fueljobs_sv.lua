...
RegisterServerEvent('esx_fueljob:setCautionInCaseOfDrop')
AddEventHandler('esx_fueljob:setCautionInCaseOfDrop', function(caution)
  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)
  xPlayer.set('caution', caution)
end)

RegisterServerEvent('esx_fueljob:giveBackCautionInCaseOfDrop')
AddEventHandler('esx_fueljob:giveBackCautionInCaseOfDrop', function()
  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('esx_fueljob:startWork')
AddEventHandler('esx_fueljob:startWork', function(item)
  local source = source
...
RegisterServerEvent('esx_fueljob:stopWork')
AddEventHandler('esx_fueljob:stopWork', function()
  local source = source
  PlayersWorking[source] = false
  TriggerClientEvent('esx_fueljob:workStopped', source)
end)

RegisterServerEvent('esx_fueljob:caution')
AddEventHandler('esx_fueljob:caution', function(cautionType, cautionAmount, spawnPoint, vehicle)
  local source = source
  local xPlayer = ESX.GetPlayerFromId(source)
  if cautionType == "take" then
    ...
    TriggerClientEvent('esx_fueljob:spawnJobVehicle', source, spawnPoint, vehicle)
