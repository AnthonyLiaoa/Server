...
MySQL.ready(function()
	local result = MySQL.Sync.fetchAll('SELECT name FROM jobs', {})
...
AddEventHandler('esx_society:withdrawMoney', function(society, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', society.account, function(account)
    ...
    if amount > 0 and account.money >= amount then
	  ...
	  TriggerEvent("azk_discordlogs:societyMoney", xPlayer.source, xPlayer.job.label, "取出", amount)
...
AddEventHandler('esx_society:depositMoney', function(society, amount)
  ...
  if amount > 0 and xPlayer.get('money') >= amount then
	...
	TriggerEvent("azk_discordlogs:societyMoney", xPlayer.source, xPlayer.job.label, "放入", amount)
  ...
  if amount > 0 and account.money >= amount then
      ...
      MySQL.Async.execute(
        ...
        function(rowsChanged)
          ...
          xPlayer.addMoney(amount)
          if society == 'society_thelostmc' then
            TriggerEvent('azk_discordlogs:ThelostmcLogs', 'wash', source, amount)
          elseif society == 'society_grove' then
