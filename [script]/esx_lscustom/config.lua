...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = -458.74, y = 176.49, z = 75.04},
		Size  = {x = 3.0, y = 3.0, z = 0.8},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
		Hint  = '按 ~INPUT_PICKUP~ 來改裝車輛'
	},

	ls2 = {
		Pos   = { x = -466.23, y = 176.83, z = 75.04},
		Size  = {x = 3.0, y = 3.0, z = 0.8},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
--[[	ls5 = {
		Pos   = { x = 1018.04, y = -2334.61, z = 30.55},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
