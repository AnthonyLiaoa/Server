...
Citizen.CreateThread(function()
	...
	while true do
		...
		if dist <= 350.0 and IsEntityDead(playerPed) and no == false then
			...
			ESX.ShowAdvancedNotification('暗區', '~r~醫療組', '~p~即將在5秒內復活', 'CHAR_BLANK_ENTRY', 7, true, true, 150)
		end
		...
		if dist <= 350.0 and IsEntityDead(playerPed) and no == false then
			...
			if spawnpoint == 1 then
				SetEntityCoords(playerPed, 1512.23, 3572.74, 37.74, true, true, true, false)
				print('a')
				TriggerServerEvent('esx_darkzone:dead1')
			elseif spawnpoint == 2 then
				SetEntityCoords(playerPed, 1536.53, 3589.03, 41.12, true, true, true, false)
				print('b')
				TriggerServerEvent('esx_darkzone:dead2')
			elseif spawnpoint == 3 then
				SetEntityCoords(playerPed, 1585.48, 3621.56, 34.42, true, true, true, false)
				print('c')
				TriggerServerEvent('esx_darkzone:dead3')
			elseif spawnpoint == 4 then
				SetEntityCoords(playerPed, 1598.8, 3599.77, 34.37, true, true, true, false)
				print('d')
				TriggerServerEvent('esx_darkzone:dead4')
			elseif spawnpoint == 5 then
				SetEntityCoords(playerPed, 1570.37, 3616.58, 37.73, true, true, true, false)
				print('e')
				TriggerServerEvent('esx_darkzone:dead5')
			elseif spawnpoint == 6 then
				SetEntityCoords(playerPed, 1609.49, 3567.8, 41.12, true, true, true, false)
				print('f')
				TriggerServerEvent('esx_darkzone:dead6')
			elseif spawnpoint == 7 then
				SetEntityCoords(playerPed, 1561.31, 3523.23, 34.79, true, true, true, false)
				print('g')
				TriggerServerEvent('esx_darkzone:dead7')
			elseif spawnpoint == 8 then
				SetEntityCoords(playerPed, 1499.49, 3532.33, 35.22, true, true, true, false)
				print('h')
