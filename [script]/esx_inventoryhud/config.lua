...
Config.OpenControl = 197 -- Key for opening inventory. Edit html/js/config.js to change key for closing it.

Config.EnableVehicleKey = false
Config.EnableHouseKey = false
Config.CloseUiItems = {"certificate"}
