...
function inventoryPoliceSetup(items) {
    ...
    $.each(items, function (index, item) {
        ...
        }else if(item.name == "bread" || item.name == "chickenbento" || item.name == "porkrice" || item.name == "beefnoodles" || item.name == "gravalemontea" || item.name == "milktea" || item.name == "donut1" || item.name == "donut2" || item.name == "pie"){
        ...
        if(item.name == "water" || item.name == "cola" || item.name == "bread" || item.name == "chickenbento" || item.name == "porkrice" || item.name == "beefnoodles" || item.name == "gravalemontea" || item.name == "milktea"){
            itemtype = "item_food";
...
function inventorySetup(items) {
    ...
    $.each(items, function (index, item) {
        ...
        var itemtype = "normal";
        var itemimage = "items"
        if(item.name == "water" || item.name == "cola" || item.name == "beer" || item.name == "gravalemontea" || item.name == "milktea" || item.name == "juice"){
            using_icon = 'local_drink';
        }else if(item.name == "bread" || item.name == "burger" || item.name == "chickenbento" || item.name == "porkrice" || item.name == "beefnoodles" ){
            using_icon = 'restaurant_menu';
        }else if(item.name == "smoke"){
            using_icon = 'smoking_rooms';
        }else if(item.name == "key"){
        ...
        if(item.name == "water" || item.name == "cola" || item.name == "bread"  || item.name == "beer" || item.name == "gravalemontea" || item.name == "milktea" || item.name == "chickenbento" || item.name == "porkrice" || item.name == "beefnoodles" ){
            itemtype = "item_food";
        }else if(item.name == "key" || item.name == "keyhouse"){
            itemtype = "item_key";
        }
        ...
        var html_items = '<div id="item-' + index + '" class="col slot-1 action faster" style="padding: 0px;display: none;" data-index="'+ index +'" data-type="inventory" data-item-type="'+ itemtype +'">' + 
                                    '<div class="card slot z-depth-0">' +
                                        '<div class="card-image" align="center" style="padding: 15px;">' +
											'<img src="img/' + itemimage + '/' + item.name + '.png" style="width: 120px;height: 120px;">' +
											//'<img src="img/' + itemimage + '/' + item.name + '.png">' +											
											//'<span class="card-title">'+ item.label +'</span>' + 
                                        '</div>' + 
                                        '<div class="card-content" align="center" style="padding: 0;text-transform: capitalize;">' +  itemname + '</div>' + 
                                        '<div class="card-content" align="center" style="padding: 10px 0 10px 0;">' + count + '</div>' + 
