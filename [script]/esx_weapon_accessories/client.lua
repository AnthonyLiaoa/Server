...
Citizen.CreateThread(function()
	...
	while true do
		...
		local menusOpenStatus = {mainMenu:Visible(), clipmenu:Visible(), scopemenu:Visible(), removeMenu:Visible(), Rclipmenu:Visible(), Rscopemenu:Visible(), skinMenu:Visible(), colorMenu:Visible()}
		for _,isOpen in ipairs(menusOpenStatus) do
			if isOpen then
...
function SetWeaponClips(type)
    ...
    if type == 'clip' then
        ...
        elseif WeaponHash == GetHashKey("WEAPON_GRENADELAUNCHER") then
            ...
            TriggerEvent('esx:showNotification', '你必須~g~手持~s~武器或武器~r~不支援~s~此改裝')
        end
...
function SetWeaponSkins(type)
    ...
    if type == 'skin' then
        ...
        elseif WeaponHash == GetHashKey("WEAPON_MARKSMANRIFLE") then
            ...
            TriggerEvent('esx:showNotification', '你必須~g~手持~s~武器或武器~r~不支援~s~此塗裝')
        end
...
function SetWeaponColors(type)
	...
	-- 手槍
	if WeaponHash == GetHashKey("WEAPON_PISTOL") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_PISTOL", type)
	elseif WeaponHash == GetHashKey("WEAPON_COMBATPISTOL") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_COMBATPISTOL", type)		
	elseif WeaponHash == GetHashKey("WEAPON_APPISTOL") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_APPISTOL", type)		
	elseif WeaponHash == GetHashKey("WEAPON_PISTOL50") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_PISTOL50", type)		
	elseif WeaponHash == GetHashKey("WEAPON_SNSPISTOL") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_SNSPISTOL", type)		
	elseif WeaponHash == GetHashKey("WEAPON_HEAVYPISTOL") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_HEAVYPISTOL", type)		
	elseif WeaponHash == GetHashKey("WEAPON_REVOLVER") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_REVOLVER", type)		
	elseif WeaponHash == GetHashKey("WEAPON_REVOLVER_MK2") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_REVOLVER_MK2", type)		
	elseif WeaponHash == GetHashKey("WEAPON_SNSPISTOL_MK2") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_SNSPISTOL_MK2", type)	
	elseif WeaponHash == GetHashKey("WEAPON_PISTOL_MK2") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_PISTOL_MK2", type)
		
	-- 衝鋒槍
	elseif WeaponHash == GetHashKey("WEAPON_MICROSMG") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_MICROSMG", type)	
	elseif WeaponHash == GetHashKey("WEAPON_SMG") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_SMG", type)	
	elseif WeaponHash == GetHashKey("WEAPON_ASSAULTSMG") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_ASSAULTSMG", type)	
	elseif WeaponHash == GetHashKey("WEAPON_SMG_MK2") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_SMG_MK2", type)	

	-- 散彈槍
	elseif WeaponHash == GetHashKey("WEAPON_PUMPSHOTGUN") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_PUMPSHOTGUN", type)
	elseif WeaponHash == GetHashKey("WEAPON_SAWNOFFSHOTGUN") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_SAWNOFFSHOTGUN", type)
	elseif WeaponHash == GetHashKey("WEAPON_PUMPSHOTGUN_MK2") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_PUMPSHOTGUN_MK2", type)	

	-- 步槍
	elseif WeaponHash == GetHashKey("WEAPON_ASSAULTRIFLE") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_ASSAULTRIFLE", type)	
	elseif WeaponHash == GetHashKey("WEAPON_CARBINERIFLE") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_CARBINERIFLE", type)	    
	elseif WeaponHash == GetHashKey("WEAPON_ADVANCEDRIFLE") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_ADVANCEDRIFLE", type)	   
	elseif WeaponHash == GetHashKey("WEAPON_SPECIALCARBINE") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_SPECIALCARBINE", type)
	elseif WeaponHash == GetHashKey("WEAPON_BULLPUPRIFLE") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_BULLPUPRIFLE", type)
	elseif WeaponHash == GetHashKey("WEAPON_BULLPUPRIFLE_MK2") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_BULLPUPRIFLE_MK2", type)
	elseif WeaponHash == GetHashKey("WEAPON_SPECIALCARBINE_MK2") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_SPECIALCARBINE_MK2", type)
	elseif WeaponHash == GetHashKey("WEAPON_ASSAULTRIFLE_MK2") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_ASSAULTRIFLE_MK2", type)
	elseif WeaponHash == GetHashKey("WEAPON_CARBINERIFLE_MK2") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_CARBINERIFLE_MK2", type)	     

	-- 機關槍
	elseif WeaponHash == GetHashKey("WEAPON_MG") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_MG", type)
	elseif WeaponHash == GetHashKey("WEAPON_COMBATMG") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_COMBATMG", type)
	elseif WeaponHash == GetHashKey("WEAPON_COMBATMG_MK2") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_COMBATMG_MK2", type)

	-- 狙擊槍
	elseif WeaponHash == GetHashKey("WEAPON_SNIPERRIFLE") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_SNIPERRIFLE", type)
	elseif WeaponHash == GetHashKey("WEAPON_MARKSMANRIFLE_MK2") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_MARKSMANRIFLE_MK2", type)
	elseif WeaponHash == GetHashKey("WEAPON_HEAVYSNIPER_MK2") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_HEAVYSNIPER_MK2", type)
	elseif WeaponHash == GetHashKey("WEAPON_MARKSMANRIFLE") then
		TriggerServerEvent("SetWeaponToSQL", "WEAPON_MARKSMANRIFLE", type)
