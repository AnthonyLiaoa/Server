...
function OpenActionMenuInteraction(target)
	...
	table.insert(elements, {label = ('穿上衣服'), value = 'ubie'})
	table.insert(elements, {label = ('脫去上衣'), value = 'tul'})
	table.insert(elements, {label = ('脫去褲子'), value = 'spo'})
	table.insert(elements, {label = ('脫去鞋子'), value = 'but'})
	table.insert(elements, {label = ('穿脫帽子'), value = 'hat'})
