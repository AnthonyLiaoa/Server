...
Citizen.CreateThread(function() 
  ...
  while true do
    ...
    local secondsBetweenAnimTosse = Config.MaxMillSecTosse
    health = GetEntityHealth(playerPed)
    newHealth = math.min(maxHealth , math.floor(health - maxHealth/10))
...
Citizen.CreateThread(function()  
  ...
  while true do
    ...
    local secondsBetweenAnimStomaco = Config.MinMillSecStomaco
