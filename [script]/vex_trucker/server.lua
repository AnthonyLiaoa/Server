...
Citizen.CreateThread(function()
	Citizen.Wait(10000)
	while true do 
		local sql = "SELECT d.driver_id, d.user_id, d.name, d.product_type, d.distance, d.valuable, d.fragile, d.fast, d.price, d.price_per_km FROM trucker_trucks t INNER JOIN trucker_drivers d ON (t.driver = d.driver_id)WHERE t.driver <> 0 AND t.driver IS NOT NULL";
