...
Citizen.CreateThread(function()
    ...
    if ESX.IsPlayerLoaded() then
        ...
        local carmodel = GetHashKey('batpod')
        ...
        Citizen.CreateThread(function()
            ...
            _wheel = CreateObject(model, 1110.45, 229.42, -48.44, false, false, true)
            ...
            local vehicle = CreateVehicle(carmodel, 1100.11, 219.93, -48.47, 0.0, false, false)
