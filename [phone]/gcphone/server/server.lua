...
function getPhoneRandomNumber()
    local numBase0 = math.random(0,99999)
    local numBase1 = math.random(0,9999)
    local num = string.format("%05d", numBase0)
	return num
end
...
AddEventHandler('onMySQLReady', function ()
    MySQL.Async.fetchAll("DELETE FROM phone_messages WHERE (DATEDIFF(CURRENT_DATE,time) > 7)")
end)
