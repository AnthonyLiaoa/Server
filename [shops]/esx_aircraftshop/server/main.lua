...
MySQL.ready(function()
	Categories     = MySQL.Sync.fetchAll('SELECT name, label FROM aircraft_categories')
	local vehicles = MySQL.Sync.fetchAll('SELECT categoryLabel, category  FROM aircrafts')
...
AddEventHandler('esx_aircraftshop:setVehicleOwned', function(vehicleProps)
	...
	MySQL.Async.execute('INSERT INTO owned_vehicles (owner, plate, vehicle, type) VALUES (@owner, @plate, @vehicle, @type)',
	{
		...
		TriggerEvent("esx:buyaircraft", xPlayer.name, xPlayer.identifier, vehicleProps.plate)
	end)
end)
