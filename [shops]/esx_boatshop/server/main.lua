...
MySQL.ready(function()
	Categories     = MySQL.Sync.fetchAll('SELECT name, label FROM boat_categories')
	local vehicles = MySQL.Sync.fetchAll('SELECT categoryLabel, category FROM boats')
...
AddEventHandler('esx_boatshop:setVehicleOwned', function(vehicleProps)
	...
	MySQL.Async.execute('INSERT INTO owned_vehicles (owner, plate, vehicle, type) VALUES (@owner, @plate, @vehicle, @type)',
	{
		...
		TriggerEvent("esx:buyboat", xPlayer.name, xPlayer.identifier, vehicleProps.plate) 
	end)
end)
