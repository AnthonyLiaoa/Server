...
local text = "~g~[E]~w~ 來啦! " -- lockpick the door
local textUnlock = "~g~[E]~w~ 終於要進去了!!" -- enter the house
local insideText = "~g~[E]~w~ 沒東西了只好閃了!" -- exit the door
local searchText = "~g~[E]~w~ 亂翻一通!!" -- search the spot
local emptyMessage = "蝦咪攏謀啦!!" -- if you press E where it is empty
local emptyMessage3D = "~r~蝦咪攏謀啦!!" -- if the spot is empty
local closetText = "~g~[E]~w~ 翻找高級住宅物品!!" -- text at closet

local lockpickQuestionText = "你確定使用高級住宅的鑰匙進入?" -- confirmation menu title
local noLockpickText = "你沒有高級住宅的鑰匙啦!自己去做啦!" -- if you don't have a lockpick and you try to do the burglary
local yesText = "要啦!我要搶劫他!" -- in confirmation menu
local noText = "不要啦!我心疼他!" -- -- in confirmation menu
...
local youFound = "你找到了!" -- when you steal something
local burglaryDetected = "警察偵測到了,還不快跑?" -- text 1 cops gets sent
local sentPhoto = "你的自拍照被回傳到警察總部!!" -- if you use qalle's camerasystem this will be in the message too
...
local burglaryInside = {
    ["gundesign02"] = { x = 342.23, y = -1003.29, z = -99.0, item = 'gundesign02', amount = math.random(1,2)},
    ["carbon"]  = {x = 338.14, y = -997.69, z = -99.2, item = 'carbon', amount = math.random(1,2)},
    ["diamond"] = { x = 350.91 , y = -999.26 , z = -99.2, item = 'diamond', amount = math.random(1,2)},
    ["bitcoin"] = { x = 349.19, y = -994.83, z = -99.2, item = 'bitcoin', amount = math.random(3,10)},
    ["gundesign01"]  = { x = 345.3, y = -995.76, z = -99.2, item = 'gundesign01', amount = math.random(1,2)},
    ["bottle"] = { x = 346.14, y = -1001.55, z = -99.2, item = 'bottle', amount = math.random(1,10)},
    ["lither"] = { x = 347.23, y = -994.09, z = -99.2, item = 'lither', amount = math.random(1,2)},
    ["olein"] = { x = 339.23, y = -1003.35, z = -99.2, item = 'olein', amount = math.random(1,2)}
}

local closets = {
    ["Robban's Closet"] = { x = 351.24, y = -993.53, z = -99.2, items = {'shirt', 'pants', 'hat', 'shoes'}, shirtAmount = math.random(1,1), pantsAmount = math.random(1,1), hatAmount = math.random(1,1), shoesAmount = math.random(1,1)},
}
