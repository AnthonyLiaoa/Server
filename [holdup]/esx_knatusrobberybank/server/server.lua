		...
		if rob == false then
			...
			if (cops >= bank.needcops)then
				...
				if xPlayer.getInventoryItem('blowtorch').count >= 1 then
					...
					TriggerEvent('azk_discordlogs:RobberyLogs', 'bank', source, bank.nameofbank)
				...
				TriggerClientEvent('esx:showNotification', source, _U('min_two_police')..bank.needcops)
			end
