...
Banks = {
	--[[["fleeca"] = {
		...
		reward = math.random(6000000,7000000), -- the random range of amount of money you will get for robbery this site
	...
	--[[["fleeca2"] = {
		...
		reward = math.random(6000000,7000000),
	...
	["PrincipalBank"] = {
		...
		needcops = 6,
		reward = math.random(11000000,13000000),
